...
import { useLogin, type LoginRequestRole } from "@/lib/api-client"
import { Button } from "@/components/ui/button"
import { Input } from "@/components/ui/input"
import { Label } from "@/components/ui/label"
import { Sparkles, ArrowRight, ShieldCheck, Activity, Zap } from "lucide-react"
        ...
        >
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            {loginMutation.isError && (
              <p className="text-destructive text-sm text-center">Invalid credentials. Try the demo accounts below.</p>
            )}
          </form>
